...
export default function AddUser() {
  ...
  const onSubmit = async (e) => {
    ...
    // Valido el formulario antes de enviar la solicitud
    if (!isFormValid()) {
      setErrorMessage("Error, please fill in all required fields");
      return;
    }

    // Valido que no haya espacios al principio o al final de nombre y apellido
    ...
    // Valido que no haya espacios en blanco en nombre, apellido y trabajo, a menos que estén seguidos por una letra
    ...
    // Valido que el DNI tenga entre 7 y 8 números
    ...
    try {
      // Hago la solicitud a la API de validación
